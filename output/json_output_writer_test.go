...
func TestJsonWriterOutputsErrorStatusWhenResponseIsFailure(t *testing.T) {
	...
	writer.WriteResponse(*NewResponseInfo(400, "400 BadRequest", "HTTP/1.1", map[string][]string{}, bytes.NewReader([]byte{})))
...
func TestJsonWriterOutputsResponseBody(t *testing.T) {
	...
	writer.WriteResponse(*NewResponseInfo(200, "200 OK", "HTTP/1.1", map[string][]string{}, output))
