...
var AvailablePlugins = map[string]ExternalPluginDefinition{
	// uipcli - crossplatform
	UipCliCrossPlatform: *NewExternalPluginDefinition(
	...
	// uipcli - windows
	UipCliWindows: *NewExternalPluginDefinition(
